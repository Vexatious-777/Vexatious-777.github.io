    ...
    handler: () => {
      window.location.href = "/Portfolio/";
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-deployed-on-9-19-2025",
          title: 'Deployed on 9/19/2025.',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://discord.com/users/142084978350620672", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%6C%65%78%61%6E%64%65%72.%67%72%69%66%66%69%74%68.%31%32@%6F%75%74%6C%6F%6F%6B.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Vexatious-777", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/alexg12", "_blank");
        },
      },{
      id: 'light-theme',
